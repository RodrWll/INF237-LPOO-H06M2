...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// 
			this->mantenimientoToolStripMenuItem->DropDownItems->AddRange(gcnew cli::array< System::Windows::Forms::ToolStripItem^  >(1) { this->carrerasToolStripMenuItem });
			...
			this->carrerasToolStripMenuItem->Size = System::Drawing::Size(146, 26);
